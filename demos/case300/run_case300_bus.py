"""
Run TSUM on IEEE 300-bus DC-OPF blackout model (branches + buses).

Components: 711 total (300 buses + 411 branches)
  - 69 generator buses: 4-state (0=removed, 1=40%cap, 2=80%cap, 3=full)
  - 231 ordinary buses: 2-state (0=failed, 1=operational)
  - 411 branches: 2-state (0=failed, 1=operational)
System function: DC-OPF, blackout_threshold=26.1% (Scenario 1 from paper)
Reference: Chan et al. (2024), Table 2: p_f ~ 1.0e-4

Usage:
    python run_case300_bus.py
    python run_case300_bus.py --unk-prob-thres 1e-4
...
def parse_args():
    parser = argparse.ArgumentParser(description="TSUM on IEEE 300-bus DC-OPF")
...
def main():
    ...
    print("=" * 60)
    print("TSUM on IEEE 300-bus DC-OPF (branches + buses)")
    print("=" * 60)
    ...
    print(f"  Threshold:   26.1% blackout (Scenario 1)")
