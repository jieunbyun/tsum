...
cells.append(code_cell(r'''TSUMPATH = Path("tsum_res")
...
cells.append(md_cell(
    ...
    "4. **System state** is determined by applying the pre-computed rules to "
    "the post-cascade component vector via "
    "`tsum.classify_samples_with_indices`. Unknown samples are resolved by "
