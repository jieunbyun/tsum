"""
Run TSUM on IEEE 118-bus DC-OPF blackout model (branches + buses).
...
def parse_args():
    parser = argparse.ArgumentParser(description="TSUM on IEEE 118-bus DC-OPF")
...
def main():
    ...
    print("=" * 60)
    print("TSUM on IEEE 118-bus DC-OPF (branches + buses)")
    print("=" * 60)
